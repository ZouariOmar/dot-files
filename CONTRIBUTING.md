# Contributing to dot-files

Thank you for your interest in contributing to dot-files! Contributions from the community are welcome and appreciated.
...
2. Clone your fork to your local machine:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/dot-files.git
   ```
...
Please check the [issues](https://github.com/dot-files/issues) tab to see where help is needed.
...
By contributing to dot-files, you agree that your contributions will be licensed under the same license as the project.
